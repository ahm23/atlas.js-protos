...
export const nebulixProtoRegistry: ReadonlyArray<[string, GeneratedType]> = [...nebulixStorageV1TxRegistry.registry];
...
export const getGrpcSigningNebulixClientOptions = ({
  defaultTypes = defaultRegistryTypes
}: {
  defaultTypes?: ReadonlyArray<[string, GeneratedType]>;
} = {}): {
...
export const getGrpcSigningNebulixClient = async ({
  rpcEndpoint,
  signer,
  defaultTypes = defaultRegistryTypes
}: {
